================================================================================
MICROSOFT FOUNDATION CLASS ライブラリ: FileCreater プロジェクトの概要
===============================================================================

アプリケーション ウィザードが作成した FileCreater には Microsoft 
Foundation Class の基本的な使い方が示されています。アプリケーション作成のひな型
としてお使いください。

このファイルには FileCreater アプリケーションを構成している各ファイ
ルの概要説明が含まれます。
...
FileCreater.h
   ...
   CFileCreaterApp アプリケーション クラスを宣言します。

FileCreater.cpp
   これは、アプリケーション クラス CFileCreaterApp を含むメイン アプリケー
   ション ソース ファイルです。
...
res\FileCreater.ico
   ...
   アイコンはメイン リソース ファイル FileCreater.rc に含まれていま
   す。
...
FileCreaterDlg.h, FileCreaterDlg.cpp - ダイアログ
   これらのファイルは CFileCreaterDlg クラスを含みます。このクラスはアプ
   リケーションのメイン ダイアログの動作を定義します。ダイアログ テンプレートは
   Microsoft Visual C++ で編集可能な FileCreater.rc に含まれます。
...
StdAfx.h, StdAfx.cpp
   ...
   FileCreater.pch や既にコンパイルされた型のファイル StdAfx.obj を
   ビルドするために使用されます。
